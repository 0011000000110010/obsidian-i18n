export default {
    ...
    //      公共区域
    // ====================
    PUBLIC_SUCCESS: 'Succès',
    PUBLIC_FAILURE: 'Échec',

    // ====================
    //      主要区域
    // ====================
    I18N_NAME: 'I18N',
    I18N_HELP_TITLE_NAME: 'Vous rencontrez des difficultés ? Rejoignez rapidement le groupe QQ pour consultation !',
    I18N_HELP_TITLE_QQ_BUTTON_TIP: 'Accès direct, rejoignez le groupe QQ et partagez les plaisirs !',
    ...
    I18N_ITEM_LABEL_D_NAME: 'Périmé',
    I18N_ITEM_LABEL_BCD_DESC_AUTHOR: 'Auteur',
    I18N_ITEM_LABEL_BCD_DESC_VERSION: 'Version supportée',
    I18N_ITEM_LABEL_E_NAME: 'Erreur de traduction',
    I18N_ITEM_LABEL_E_DESC: 'Le format peut contenir des erreurs, veuillez vérifier attentivement avant de réessayer',
    I18N_ITEM_LABEL_F_NAME: 'Traduction chinoise existante',
    I18N_ITEM_LABEL_F_DESC: 'Selon les commentaires, ce plugin peut avoir une traduction chinoise intégrée',
    I18N_ITEM_LABEL_G_DESC: 'Non applicable',

    I18N_ITEM_OPEN_SETTING_BUTTON_TIP: 'Ouvrez les paramètres du plugin',

    I18N_ITEM_OPEN_DIR_BUTTON_TIP: 'Ouvrez le répertoire du plugin',
    I18N_ITEM_OPEN_DIR_BUTTON_NOTICE_HEAD: 'Ouverture du répertoire',

    I18N_ITEM_DELETE_DIR_BUTTON_TIP: 'Supprimez le répertoire de traduction',
    ...
    I18N_ITEM_DOWNLOAD_TRANSLATION_BUTTON_TEXT: 'Téléchargement',
    I18N_ITEM_DOWNLOAD_TRANSLATION_BUTTON_TIP: 'Télécharger les traductions à partir du réseau',
    I18N_ITEM_DOWNLOAD_TRANSLATION_BUTTON_NOTICE_HEAD: 'Téléchargement de traduction',
    I18N_ITEM_DOWNLOAD_TRANSLATION_BUTTON_NOTICE_CONTENT_A: '',

    I18N_ITEM_UPDATE_TRANSLATION_BUTTON_TEXT: 'Mise à jour',
    I18N_ITEM_UPDATE_TRANSLATION_BUTTON_TIP: 'Mettre à jour les traductions locales avec les traductions du réseau',
    I18N_ITEM_UPDATE_TRANSLATION_BUTTON_NOTICE_HEAD: 'Mise à jour de la traduction',
    I18N_ITEM_UPDATE_TRANSLATION_BUTTON_NOTICE_CONTENT_A: '',

    I18N_ITEM_MACHINE_TRANSLATION_BUTTON_TIP: 'Générer des traductions traduites',
    ...
    I18N_ITEM_TRANSLATION_BUTTON_NOTICE_CONTENT_A: 'Si le plugin ne fonctionne pas après la traduction\nCela peut indiquer que la traduction a des problèmes\nCliquez sur restaurer pour revenir à l\'état d\'origine',
    ...
    I18N_STATE_HEAD: 'Fichier d\'état',
    I18N_UPDATE_HEAD: 'Mise à jour du plugin',

    // ====================
    //      Wizard区域
    // ====================
    WIZARD_VIDEO_TUTORIAL_TITLE_NAME: 'Tutoriel vidéo officiel',
    WIZARD_VIDEO_TUTORIAL_TITLE_DESC: 'Démonstration détaillée de l\'opération i18n d\'Obsidian, pour vous aider à maîtriser rapidement',
    WIZARD_VIDEO_TUTORIAL_BUTTON_TEXT: 'Explorer',

    WIZARD_DOCUMENTATION_TUTORIAL_TITLE_NAME: 'Tutoriel de documentation officiel',
    WIZARD_DOCUMENTATION_TUTORIAL_TITLE_DESC: 'Guide de la découverte complète d\'Obsidian i18n',
    ...
    SUBMITE_TITLE_DESC: 'Veuillez relire attentivement avant de soumettre, nous apprécions sincèrement votre coopération et vos efforts.',
    ...
    SUBMITE_INSPECT_NOTICE_B: 'L auteur ne peut être vide',
    SUBMITE_INSPECT_NOTICE_C: 'Le contenu de la traduction est conforme aux normes',
    SUBMITE_INSPECT_NOTICE_D: 'Le contenu de la traduction ne dépasse pas 50%',
    SUBMITE_INSPECT_NOTICE_E: 'Le format de la version doit être (X.X.X)',

    // ====================
    //       编辑区域
    // ====================
    EDITOR_PUBLIC_HEAD: 'Éditeur de traduction',
    ...
    EDITOR_CANCEL_ITEM_BUTTON_NOTICE_CONTENT_A: 'Annuler la sélection',
    EDITOR_DELETE_ITEM_BUTTON_TEXT: 'Supprimer',
    EDITOR_DELETE_ITEM_BUTTON_NOTICE_CONTENT_A: 'Suppression réussie',
    EDITOR_DELETE_ITEM_BUTTON_NOTICE_CONTENT_B: 'Échec de la suppression',
    EDITOR_INSERT_ITEM_BUTTON_TEXT: 'Ajouter',
    EDITOR_INSERT_ITEM_BUTTON_NOTICE_CONTENT_A: 'Ajout réussi',
    EDITOR_INSERT_ITEM_BUTTON_NOTICE_CONTENT_B: 'Échec de l\'ajout\nCe contenu existe déjà dans la traduction',
    EDITOR_INSERT_ITEM_BUTTON_NOTICE_CONTENT_C: 'Échec de l\'ajout\nVeuillez annuler la sélection avant d\'ajouter',
    ...
    SETTING_BASE_TITLE_NAME: 'Paramètres de base',

    SETTING_HELP_NAME: 'Aide',

    SETTING_LANGUAGE_NAME: 'Langue',
    SETTING_LANGUAGE_DESC: 'Choisissez la langue à traduire',
    ...
    SETTING_LDT_AUTOMATIC_UPDATE_DESC: 'Appliquez automatiquement les traductions locales existantes après la détection d\'un changement de version du plugin (attention aux erreurs possibles suite à la mise à jour du plugin)',
    SETTING_LDT_AUTOMATIC_UPDATE_NOTICE_A: 'Commencer à vérifier les mises à jour',
    SETTING_LDT_AUTOMATIC_UPDATE_NOTICE_B: 'Aucune mise à jour de plugin nécessaire',
    ...
    SETTING_NDT_MODE_NOTICE_B: 'Anomalie réseau',
    SETTING_NDT_PUBLIC_IGNORE_HEAD: 'Marquer la traduction chinoise',
    SETTING_NDT_APIS_NAME: 'API',
    SETTING_NDT_APIS_DESC: 'Veuillez entrer l\'API correspondante à la langue que vous souhaitez traduire (ajouter de nouveau la couvrira)',
    SETTING_NDT_APIS_INSERT_BUTTON: 'Ajouter',
    SETTING_NDT_IGNORE_NAME: 'Marquer la traduction chinoise',
    SETTING_NDT_IGNORE_DESC: 'Marquer les plugins avec une traduction chinoise intégrée (basé sur les commentaires de la communauté, nécessite une connexion réseau)',
    SETTING_NDT_IGNORE_NOTICE_A: 'L\'API de la langue actuelle n\'existe pas',
    SETTING_NDT_IGNORE_NOTICE_B: 'Anomalie réseau',
    ...
    SETTING_NIT_INTERVAL_DESC: 'Utilisé pour limiter l\'intervalle de chaque demande (unité: millisecondes)',

    SETTING_NIT_BAIDU_NAME: 'Baidu',
    SETTING_NIT_BAIDU_DESC: 'Traduction basée sur l\'API Baidu',

    SETTING_NIT_OPENAI_NAME: 'OPENAI',
    SETTING_NIT_OPENAI_DESC: 'Traduction basée sur l\'API OPENAI',
    SETTING_NIT_OPENAI_TIP_NAME: 'Indice',
    SETTING_NIT_OPENAI_TIP_DESC: 'C\'est-à-dire le prompt, utilisé pour guider l\'AI dans la traduction, ce plugin fournit des mots indicatifs par défaut, mais vous pouvez les ajuster si nécessaire.',
    SETTING_NIT_OPENAI_TIP_PLACEHOLDER: 'Mots indicatifs',

    SETTING_MORE_TITLE_NAME: 'Plus de fonctionnalités',

    SETTING_Author_NAME: 'Signature de la traduction',
    SETTING_Author_DESC: 'Ajouter automatiquement la signature de l\'auteur lors de la génération de la traduction',
    SETTING_Author_PLACEHOLDER: 'Signature',

    SETTING_OPEN_SETTING_NAME: 'Ouvrir les paramètres',
    SETTING_OPEN_SETTING_DESC: 'Une fois activé, un bouton de saut vers les paramètres apparaîtra dans la page du plugin',

    SETTING_EDITOR_NAME: 'Éditeur de traduction',
    SETTING_EDITOR_DESC: 'Activer/désactiver la fonctionnalité de l\'éditeur de traduction intégré',

    SETTING_CLOUD_COLLABORATION_NAME: 'Collaboration cloud',
    SETTING_CLOUD_COLLABORATION_DESC: 'Une fois cette fonction activée, vous pouvez soumettre votre traduction, demander une traduction pour un plugin spécifique, marquer si un plugin a une traduction chinoise intégrée. Rejoignez notre communauté et contribuez !',

    SETTING_CLOUD_COLLABORATION_TOKEN_NAME: 'Jeton Gitee',
    SETTING_CLOUD_COLLABORATION_TOKEN_DESC: 'Veuillez fournir votre jeton pour prendre en charge les soumissions groupées (facultatif)',
    SETTING_CLOUD_COLLABORATION_TOKEN_PLACEHOLDER: 'Jeton',

    SETTING_RE_TITLE_NAME: 'Configuration des modèles de correspondance',

    SETTING_RE_MODE_NAME: 'Mode',
    SETTING_RE_MODE_DESC: 'Le mode de correspondance actuellement utilisé',
    ...
    SETTING_RE_EDIT_MODE_NAME: 'Édition du mode',
    ...
    SETTING_RE_EDIT_INSERT_BUTTON_CONTENT_A: 'Le nom du mode RE est en double, impossible à ajouter',

    SETTING_RE_EDIT_DELETE_BUTTON_CONTENT_A: 'Échec de la suppression',

    SETTING_RE_EDIT_ITEM_NAME: 'Édition des données',
    SETTING_RE_EDIT_ITEM_DESC: 'Ajouter et supprimer des données de mode d\'expression rationnelle',
